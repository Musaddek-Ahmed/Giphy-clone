...
const Header = () => {
  ...
  return (
    <nav>
      <div className='relative flex gap-4 justify-between items-center mb-2'>
        ...
        <h1 className='text-4xl font-bold tracking-light cursor-pointer'>
          GIPHY
        </h1>
        </Link>
  ...
  key={category.name}
  to={`/${category.name_encoded}`}
  className='font-bold border-b-2 border-transparent hover:border-white transition-colors duration-200'
>
  {category.name}
</Link>
              )
